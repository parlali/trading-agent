...
export declare const VENUE_APPS: readonly ["alpaca-options", "polymarket", "mt5", "binance-futures"];
export declare const ACTIVE_VENUE_APPS: readonly ["alpaca-options", "polymarket", "mt5"];
export type ActiveVenueApp = typeof ACTIVE_VENUE_APPS[number];
export type VenueApp = typeof VENUE_APPS[number];
export declare const APPS: readonly ["alpaca-options", "polymarket", "mt5", "binance-futures", "backend"];
export type App = typeof APPS[number];
export declare const SEVERITY_LEVELS: readonly ["critical", "warning", "info"];
export type Severity = typeof SEVERITY_LEVELS[number];
export declare const EVENT_TYPES: readonly ["intent", "validation", "submission", "fill_update", "filled", "rejected", "cancelled"];
export type EventType = typeof EVENT_TYPES[number];
export declare const ORDER_SIDES: readonly ["buy", "sell"];
export type OrderSide = typeof ORDER_SIDES[number];
export declare const EXECUTION_ERROR_SOURCES: readonly ["risk_engine", "pre_validation", "venue", "network", "timeout", "internal"];
export type ExecutionErrorSource = typeof EXECUTION_ERROR_SOURCES[number];
export declare const ORDER_LEG_SIDES: readonly ["buy", "sell", "buy_to_open", "sell_to_open", "buy_to_close", "sell_to_close"];
...
export declare const PROVIDER_OWNERSHIP_STATUSES: readonly ["owned", "unowned", "orphaned"];
export type ProviderOwnershipStatus = typeof PROVIDER_OWNERSHIP_STATUSES[number];
export declare const PORTFOLIO_PROVIDER_STATUSES: readonly ["healthy", "degraded", "stale"];
