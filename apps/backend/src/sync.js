...
import { PERIODIC_SYNC_INTERVAL_MS, ALL_APPS, backend, healthState, logger, plugins, syncStrategies, periodicSyncInFlight, periodicSyncTimer, setPeriodicSyncInFlight, setPeriodicSyncTimer, } from "./state";
...
async function reconcileStrategies(scheduler) {
...
export function startPeriodicSync(scheduler) {
