import { APP_NAME, HEARTBEAT_INTERVAL_MS, backend, healthState, logger, heartbeatTimer, setHeartbeatTimer, } from "./state";
export function startHeartbeat() {
    setHeartbeatTimer(setInterval(async () => {
        try {
            ...
            for (const [app, venueState] of Object.entries(healthState.venues)) {
